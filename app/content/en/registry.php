 ...
 *
 * 'status' => 'live'    : content/en/pages/<id>.php exists and contains no
 *                         unwritten copy slots. The only status that can be
 *                         indexed or listed in the sitemap.
 * 'status' => 'draft'   : the content file exists and holds the finished
 *                         structure, but some copy is still a {{ brief }}.
 *                         Visitors get the "in preparation" notice; authors can
 *                         read the outline with PF_PREVIEW=1. Never indexed.
 * 'status' => 'planned' : no content file at all. Renders the same honest
 *                         notice. No dead internal links, no thin pages
 *                         pretending to be finished.
 *
 * This field is documentation, not control: resolve_page() in app/draft.php
 * derives the real status from the content file every time, and tools/qa.php
 * fails the build when the two disagree. Fill the last slot on a page and it
...
'services' => [
    'url' => '/services/', 'type' => 'service', 'status' => 'draft', 'cluster' => 'core',
...
'services.residency' => [
    'url' => '/services/residency/', 'type' => 'service', 'status' => 'draft', 'cluster' => 'services',
...
'services.permanent-residency' => [
    'url' => '/services/permanent-residency/', 'type' => 'service', 'status' => 'draft', 'cluster' => 'services',
...
'services.ruc' => [
    'url' => '/services/ruc-tax-registration/', 'type' => 'service', 'status' => 'draft', 'cluster' => 'services',
...
'services.banking' => [
    'url' => '/services/banking-support/', 'type' => 'service', 'status' => 'draft', 'cluster' => 'services',
...
'packages' => [
    'url' => '/packages/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'core',
...
'process' => [
    'url' => '/process/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'core',
...
'book' => [
    'url' => '/book-consultation/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'core',
    ...
    // The enquiry form posts to this same URL; the handler runs before render
    // so it can redirect (POST-redirect-GET). See app/form.php.
    'post_handler' => 'handle_consultation_post',
],
'about' => [
    'url' => '/about/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'core',
...
// ----------------------------------------------------------- residency -----
'guides.residency' => [
    'url' => '/guides/residency/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.requirements' => [
    'url' => '/guides/residency/requirements/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.documents' => [
    'url' => '/guides/residency/documents/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.costs' => [
    'url' => '/guides/residency/costs/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.timeline' => [
    'url' => '/guides/residency/timeline/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.temporary-vs-permanent' => [
    'url' => '/guides/residency/temporary-vs-permanent/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
'guides.residency.maintaining' => [
    'url' => '/guides/residency/maintaining-residency/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'residency',
...
// ----------------------------------------------------------------- tax -----
'guides.tax' => [
    'url' => '/guides/tax/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'tax',
...
'guides.tax.territorial' => [
    'url' => '/guides/tax/territorial-tax/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'tax',
...
'guides.tax.vs-legal' => [
    'url' => '/guides/tax/tax-vs-legal-residency/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'tax',
...
'guides.tax.ruc' => [
    'url' => '/guides/tax/ruc/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'tax',
...
// --------------------------------------------------------------- other -----
'guides.banking' => [
    'url' => '/guides/banking/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'banking',
...
'guides.citizenship' => [
    'url' => '/guides/citizenship/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'citizenship',
...
'guides.living' => [
    'url' => '/guides/living/', 'type' => 'article', 'status' => 'draft', 'cluster' => 'living',
...
'faq' => [
    'url' => '/faq/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'trust',
...
'privacy' => [
    'url' => '/privacy/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'legal',
...
'terms' => [
    'url' => '/terms/', 'type' => 'page', 'status' => 'draft', 'cluster' => 'legal',
...
// ------------------------------------------------------------- utility -----
'thank-you' => [
    'url' => '/thank-you/', 'type' => 'page', 'status' => 'live', 'cluster' => 'utility', 'index' => false,
    'title' => 'Thank You | Paraguay Frontier',
    'description' => 'Your message has been received.',
    'h1' => 'Message received', 'intent' => 'Post-submission confirmation.',
],
'error-404' => [
    'url' => '/errors/404/', 'type' => 'page', 'status' => 'live', 'cluster' => 'utility', 'index' => false,
    'title' => 'Page Not Found | Paraguay Frontier',
    'description' => 'That page does not exist.',
    'h1' => 'That page does not exist', 'intent' => 'Error recovery.',
],
'error-500' => [
    'url' => '/errors/500/', 'type' => 'page', 'status' => 'live', 'cluster' => 'utility', 'index' => false,
