...
'faqs' => [
  ['q' => 'Why will you not tell me how many months it takes?',
   'a' => ['{{ 60-90 words: because the review stage is not ours to predict and a published figure would be a guess presented as a commitment. Say what we give instead. }}']],
  ['q' => 'What can I start today?',
   'a' => ['{{ 60-90 words: the records that can be requested before any decision is made, and why starting them early costs nothing. }}']],
  ['q' => 'How long do I need to be in Paraguay?',
   'a' => ['{{ 60-90 words: which stages require presence and which do not. Be precise about what "present" means for each. }}']],
  ['q' => 'What causes most of the delay?',
   'a' => ['{{ 60-90 words: the honest ranking — applicant-side record gathering usually dominates, then authentication, then review. }}']],
],
...
['type' => 'quick-answer',
 ...
 'caveat' => '{{ 30-50 words: what would make any published estimate wrong for this reader — nationality, records, policy changes, caseload. }}',
],

['type' => 'steps',
 'eyebrow' => 'Sequence',
 'heading' => 'Stage by stage, and whose desk it is on',
 'intro' => ['{{ 40-60 words: how to read the sequence, and the note that stages overlap rather than queue neatly. }}'],
 'items' => [
   ['title' => '{{ stage 1 title — preparation, before committing }}',
    'body' => ['{{ 50-80 words: what happens, what the reader does }}'], 'who' => 'You',
    'blocker' => '{{ 20-35 words: the usual hold-up here }}'],
   ['title' => '{{ stage 2 title — obtaining and authenticating records }}',
    'body' => ['{{ 50-80 words }}'], 'who' => 'You',
    'blocker' => '{{ 20-35 words }}'],
   ['title' => '{{ stage 3 title — arrival and Paraguayan-side records }}',
    'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 4 title — filing }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 5 title — government review }}',
    'body' => ['{{ 50-80 words: describe what is happening and what "no news" means. No duration. }}'], 'who' => 'Government',
    'blocker' => '{{ 20-35 words: what can pause a file at this stage }}'],
   ['title' => '{{ stage 6 title — after approval }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'You'],
 ],
 'footnote' => '{{ 30-50 words: repeat, once, that we publish no total, and where a reader can get a schedule for their own dates. }}',
],
...
['type' => 'prose',
 ...
 'body' => [
   ...
   ['type' => 'defs', 'items' => [
     ['term' => '{{ cause 1 }}', 'def' => '{{ 40-70 words: how it arises and how to avoid it }}'],
     ['term' => '{{ cause 2 }}', 'def' => '{{ 40-70 words }}'],
     ['term' => '{{ cause 3 }}', 'def' => '{{ 40-70 words }}'],
     ['term' => '{{ cause 4 }}', 'def' => '{{ 40-70 words }}'],
   ]],
 ],
],
...
['type' => 'sources',
 'intro' => ['{{ 25-40 words: what is sourced here, given that no duration is published. }}'],
 'items' => [
...
['type' => 'next-step',
 ...
 'body' => ['{{ 40-60 words: what the consultation produces — the sequence applied to the reader\'s travel and records, with the uncontrolled stage left honestly open. }}'],
