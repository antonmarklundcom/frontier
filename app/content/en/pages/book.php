...
return [
'faqs' => [
  ['q' => 'What does the consultation cost?',        'a_html' => ['{{ 40-70 words: state the fee plainly, what it buys, and whether it is credited against an engagement. Do not publish this page until the amount is real. }}']],
  ['q' => 'What happens in the session?',            'a_html' => ['We start with where you actually are and what you are trying to achieve, because those change the answer more than anything else does. Then: which route fits, what it would require of you, which records you would have to obtain and in what order, and which stages are decided by somebody other than us. We finish with what we would do next in your position. You receive that in writing afterwards, including the parts where the answer was that we do not know.']],
  ['q' => 'What if you tell me not to proceed?',     'a_html' => ['{{ 60-90 words: that this is a real outcome and what happens to the fee. }}']],
  ['q' => 'Can we speak in Spanish?',                'a_html' => ['{{ 40-60 words: languages actually offered. }}']],
],
'blocks' => [
...
['type' => 'quick-answer', 'eyebrow' => 'What you get',
 ...
 'caveat_html' => 'This is preparation, not advice. An opinion on your own country\'s tax position needs an adviser there. A contract, a court matter or a formal legal opinion in Paraguay needs a Paraguayan lawyer, and filing returns needs an accountant.'],
['type' => 'prose', 'eyebrow' => 'Preparation', 'heading' => 'Bring these and the session is worth twice as much',
 'body_html' => ['You do not need to prepare anything in order to book. But the session turns from general to specific the moment there are real dates and real documents in front of us, so bring what you already hold rather than a tidied summary of it.',
...
['type' => 'form', 'eyebrow' => 'Enquiry', 'heading' => 'Tell us where you are',
 'intro_html' => ['This goes to the person who would handle your file. It is read rather than scored, and it starts no email sequence: the reply is written by someone who has read what you wrote. Tell us the complications rather than the summary. They are what determines whether we can help you at all, and we will say so if we cannot.']],
['type' => 'callout', 'label' => 'Who this session is not for',
 'body_html' => ['Do not book if you want a guarantee. Nobody can promise you residency, a bank account or a tax outcome, and this session will not produce one. Do not book looking for a scheme: residency is not a way to make income disappear, and we will not help anyone present it as one. And do not book hoping the decision gets made for you. We can tell you what a route involves. Whether to move your family is yours.']],
