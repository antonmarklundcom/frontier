...
return [
'faqs' => [
  ['q' => 'Are you a law firm?',                 'a_html' => ['{{ 60-90 words: no. What we are, and who we bring in. }}']],
  ['q' => 'Where are you actually based?',       'a_html' => ['{{ 60-90 words: answer once the address is confirmed; be specific about in-country presence. }}']],
  ['q' => 'How long have you been doing this?',  'a_html' => ['{{ 60-90 words: a truthful answer, with no "years of experience" figure that cannot be evidenced. }}']],
  ['q' => 'Why is there no client list?',        'a_html' => ['{{ 60-90 words: confidentiality, and no testimonials that are not real and consented to. }}']],
],
'blocks' => [
...
['type' => 'prose', 'eyebrow' => 'Why', 'heading' => 'Why this site reads differently',
 'body_html' => [
   ...
   ['type' => 'list', 'items_html' => ['{{ commitment 1 }}', '{{ commitment 2 }}', '{{ commitment 3 }}', '{{ commitment 4 }}']],
 ]],
