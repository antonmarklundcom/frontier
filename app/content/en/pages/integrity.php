...
'faqs' => [
  ['q' => 'Do you guarantee that my residency will be approved?',
   'a_html' => ['No, and nobody can. Approval is a decision of the Dirección Nacional de Migraciones, applying its own criteria and discretion to your file. What we can do is tell you before you engage us whether your situation appears to meet the published requirements, and where we think a reviewing officer is most likely to raise a question.']],
  ['q' => 'Can you tell me how long it will take?',
   'a_html' => ['We will give you a realistic sequence and tell you which stages we control. We will not give you a total, because the government review stage is not ours to predict and any figure we published would be a guess presented as a commitment.']],
  ['q' => 'Will I definitely be able to open a Paraguayan bank account?',
   'a_html' => ['No. Paraguayan banks apply their own compliance judgement to every foreign applicant and decline applications regularly, including well-prepared ones. We prepare the file and make the introduction. The decision is the bank\'s.']],
  ['q' => 'What happens if something goes wrong?',
   'a_html' => ['It depends on what went wrong and who caused it. If an error in work performed directly by Paraguay Frontier causes a problem, the remedy stated in your signed service agreement applies. Incomplete or inaccurate information from you, changes in law, government discretion and third-party fees are not covered by that, and we will say so at the time rather than after.']],
],
...
['type' => 'prose',
 ...
 'body_html' => [
   ...
   ['type' => 'defs', 'items' => [
     ['term' => 'Government discretion', 'def_html' => 'Migraciones decides who is approved. A complete, accurate, well-presented file improves how your application is read. It does not bind the decision.'],
     ['term' => 'Processing time', 'def_html' => 'The review stage runs on the government\'s timetable, which varies with caseload, policy and circumstances none of us can see. We do not publish an estimate for it.'],
     ['term' => 'Changes in law and practice', 'def_html' => 'Requirements, fees and accepted document formats change. We track them and date our guidance, but a rule can change between your first consultation and your filing.'],
     ['term' => 'Third-party decisions', 'def_html' => 'Banks, translators, notaries and your own government\'s record offices set their own standards, timelines and fees. We can prepare for them; we cannot decide for them.'],
   ]],
 ],
],
