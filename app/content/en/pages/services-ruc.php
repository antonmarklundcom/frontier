...
return [
'faqs' => [
  ['q' => 'Do I actually need a RUC?',                'a' => ['{{ 60-90 words: the honest test, linking the RUC guide. }}']],
  ['q' => 'What happens after registration?',         'a' => ['{{ 60-90 words: the filing rhythm and who does it. }}']],
  ['q' => 'Do you do the monthly filings?',           'a' => ['{{ 60-90 words: what we do versus what a Paraguayan accountant does. }}']],
  ['q' => 'Can you cancel a RUC I no longer need?',   'a' => ['{{ 60-90 words }}']],
],
'blocks' => [
...
['type' => 'quick-answer', 'eyebrow' => 'In one paragraph',
 ...
 'caveat' => '{{ 30-50 words: registration creates obligations; we say so before, not after. }}'],
['type' => 'steps', 'eyebrow' => 'The engagement', 'heading' => 'What happens, in order',
 'intro' => ['{{ 40-60 words }}'],
 'items' => [
   ['title' => '{{ stage 1 — establishing whether you need one }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 2 }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'You'],
   ['title' => '{{ stage 3 }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 4 — the handover to ongoing compliance }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'You'],
 ]],
['type' => 'callout', 'label' => 'When you should not register',
 'body' => ['{{ 60-90 words: the readers who should walk away from this service. Mandatory paragraph. }}']],
