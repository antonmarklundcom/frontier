...
'faqs' => [
  ['q' => 'Why do some pages say "in preparation" instead of just being published?',
   'a_html' => ['Because they are not finished, and a half-researched page about immigration or tax is worse than no page. A route that is in preparation renders an honest notice, is excluded from our sitemap, and is closed to search engines until the content exists and has been reviewed.']],
  ['q' => 'Is this site legal or tax advice?',
   'a_html' => ['No. It is general information about Paraguayan procedures. It cannot account for your nationality, your family situation, your existing tax exposure or your history, all of which change the answer. Where a question needs a lawyer or an accountant, our guides say so rather than stretching to cover it.']],
  ['q' => 'How do I report an error?',
   'a_html' => ['Send us the page URL, the sentence you think is wrong, and — if you have one — the source that says otherwise. We would rather receive a correction that turns out to be mistaken than not receive one that was right.']],
  ['q' => 'Do you accept payment for links or mentions in your guides?',
   'a_html' => ['No. No page on this site contains paid placement, affiliate links or sponsored mentions. The only commercial relationship we have with a reader is the service they hire us for.']],
],
...
['type' => 'prose',
 ...
 'body_html' => [
   ['type' => 'defs', 'items' => [
     ['term' => '1. Research', 'def_html' => 'Primary Paraguayan sources first. Every factual claim gets a source recorded against it before any drafting starts.'],
     ['term' => '2. Draft', 'def_html' => 'Written to answer one question, for one kind of reader, with the direct answer near the top rather than after eight paragraphs of preamble.'],
     ['term' => '3. Qualified review', 'def_html' => 'Legal content is read by a Paraguayan lawyer; tax content by a Paraguayan accountant. This is a gate, not a formality — an unreviewed page does not publish.'],
     ['term' => '4. Publish, dated', 'def_html' => 'The page goes live carrying a visible last-reviewed date, the author, and the reviewer.'],
     ['term' => '5. Re-review', 'def_html' => 'Pages are revisited when the law moves, when a reader reports a problem, or on schedule — whichever comes first.'],
   ]],
