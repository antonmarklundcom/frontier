...
return [
'faqs' => [
  ['q' => 'How often will I hear from you?',        'a' => ['{{ 60-90 words: the actual communication commitment, including that "no movement" is itself an update. }}']],
  ['q' => 'Who will I be dealing with?',            'a' => ['{{ 60-90 words: answer once real names exist; keep it honest about team size. }}']],
  ['q' => 'What do you need from me, and when?',    'a' => ['{{ 60-90 words }}']],
  ['q' => 'What if I need to pause?',               'a' => ['{{ 60-90 words: what pausing does to records that expire. }}']],
],
'blocks' => [
...
['type' => 'prose', 'eyebrow' => 'Working together', 'heading' => 'What we expect from each other',
 'body' => ['{{ 40-60 words: intro. }}',
   ['type' => 'defs', 'items' => [
     ['term' => 'What you can expect from us', 'def' => '{{ 50-80 words: response times we can actually keep, honest status, no invented progress }}'],
     ['term' => 'What we need from you',       'def' => '{{ 50-80 words: disclosure, records, responsiveness }}'],
     ['term' => 'How we handle bad news',      'def' => '{{ 50-80 words: told early, in writing, with options }}'],
   ]]]],
['type' => 'callout', 'label' => '"No movement" is an update',
 'body' => ['{{ 60-90 words: the commitment to say when nothing has happened, instead of manufacturing progress. }}']],
