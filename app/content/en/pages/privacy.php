...
['type' => 'prose', 'eyebrow' => 'Summary', 'heading' => 'The short version',
 'body_html' => ['{{ 60-90 words: what is collected, why, how long it is kept, who else sees it. Written to be understood, not to be defensible. }}']],
['type' => 'prose', 'eyebrow' => 'Detail', 'heading' => 'What is collected and why',
 'body_html' => ['{{ 40-60 words: intro. }}',
   ['type' => 'defs', 'items' => [
     ['term' => 'What you send us through the form', 'def_html' => '{{ 50-80 words: fields, purpose, retention }}'],
     ['term' => 'Cookies',                          'def_html' => '{{ 50-80 words: the single functional session cookie and where it is set }}'],
     ['term' => 'Server logs',                      'def_html' => '{{ 50-80 words: what the host records }}'],
     ['term' => 'Third parties',                    'def_html' => '{{ 50-80 words: the CRM and the mail provider, named }}'],
     ['term' => 'What we do not do',                'def_html' => '{{ 50-80 words: no analytics, no advertising, no data sale, no profiling }}'],
   ]]]],
['type' => 'prose', 'eyebrow' => 'Your rights', 'heading' => 'Correcting or deleting your data',
 'body_html' => ['{{ 60-90 words: how to ask, what happens, and how long it takes. }}',
...
['type' => 'callout', 'label' => 'Reviewed by a lawyer',
 'body_html' => ['{{ 30-50 words: who drafted or reviewed this and when. Delete this block only if the page is genuinely reviewed and the stamp moves to the page header. }}']],
