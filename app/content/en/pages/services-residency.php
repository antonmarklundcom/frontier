...
return [
'faqs' => [
  ['q' => 'What exactly do you do that I could not?',  'a_html' => ['{{ 60-90 words: the concrete work — sequencing, authentication coordination, in-country appearances, file assembly. }}']],
  ['q' => 'Do I have to travel to Paraguay?',          'a_html' => ['{{ 60-90 words: which stages require presence. }}']],
  ['q' => 'What do you need from me?',                 'a_html' => ['{{ 60-90 words: records, disclosure, responsiveness — and why the awkward facts matter most. }}']],
  ['q' => 'What if my application is refused?',        'a_html' => ['{{ 60-90 words: what happens next, and what our agreement says about it. No remedy promise beyond the signed agreement. }}']],
],
'blocks' => [
...
['type' => 'quick-answer',
 ...
 'answer_html' => ['{{ 60-90 words: the work itself, in the order it happens. }}'],
 'points_html' => ['{{ deliverable 1 }}', '{{ deliverable 2 }}', '{{ deliverable 3 }}', '{{ deliverable 4 }}'],
 'caveat_html' => '{{ 30-50 words: what is excluded, and that approval is the government\'s decision. }}'],
['type' => 'steps', 'eyebrow' => 'The engagement', 'heading' => 'What happens, in order',
 'intro_html' => ['{{ 40-60 words: from consultation to cédula, with ownership marked at each stage. }}'],
 'items' => [
   ['title' => '{{ stage 1 }}', 'body_html' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ...
   ['title' => '{{ stage 5 }}', 'body_html' => ['{{ 50-80 words }}'], 'who' => 'Us'],
 ],
 'footnote_html' => '{{ 25-40 words: no total duration, and why. }}'],
...
['type' => 'callout', 'label' => 'When you should not hire us for this',
 'body_html' => ['{{ 60-90 words: the situations where a reader is better served doing it alone or going straight to a lawyer. This paragraph is required. }}']],
...
['type' => 'next-step', 'heading' => 'A working session before any engagement',
 'body_html' => ['{{ 40-60 words: we do not take an engagement without one; say why. }}'],
