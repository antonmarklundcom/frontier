...
return [
'faqs' => [
  ['q' => 'Can you get me an account?',              'a' => ['{{ 60-90 words: no. What we do instead, in concrete terms. }}']],
  ['q' => 'Which banks do you work with?',           'a' => ['{{ 60-90 words: describe the relationship honestly; disclose any referral arrangement. }}']],
  ['q' => 'What if I am declined?',                  'a' => ['{{ 60-90 words: what happens next and what our fee covered. }}']],
  ['q' => 'Do I need residency first?',              'a' => ['{{ 60-90 words }}']],
],
'blocks' => [
...
['type' => 'quick-answer', 'eyebrow' => 'In one paragraph',
 ...
 'answer' => ['{{ 60-90 words: file preparation, document assembly, introduction, and accompanying you. Nothing about outcomes. }}'],
 'points' => ['{{ deliverable 1 }}', '{{ deliverable 2 }}', '{{ deliverable 3 }}'],
 'caveat' => '{{ 30-50 words: the bank decides, well-prepared applications are declined, and our fee is for the preparation. }}'],
...
['type' => 'callout', 'label' => 'Anyone promising you an account',
 'body' => ['{{ 60-90 words: what such a promise really means, and why we do not make it. }}']],
...
['type' => 'next-step', 'heading' => 'Have your file assessed honestly first',
 'body' => ['{{ 40-60 words: including that we will say when a file is not ready to present. }}'],
