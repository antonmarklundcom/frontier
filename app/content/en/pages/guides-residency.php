...
return [
'faqs' => [
  ['q' => 'Where should I start?',                       'a_html' => ['{{ 60-90 words: route the reader by situation, linking the right child guide. }}']],
  ['q' => 'Can I do this without a lawyer or an agent?', 'a_html' => ['{{ 60-90 words: honestly — who can, who should not, and what the failure modes are. }}']],
  ['q' => 'Is Paraguay a good idea for me at all?',      'a_html' => ['{{ 60-90 words: the cases where the answer is no, stated first. }}']],
  ['q' => 'How current is this guidance?',               'a_html' => ['{{ 40-60 words: dating and review policy, linking editorial standards. }}']],
],
'blocks' => [
...
['type' => 'quick-answer',
 ...
 'answer_html' => ['{{ 70-110 words: the landscape in one paragraph — routes, sequence, who decides. }}',
              '{{ 40-60 words: the two or three decisions a reader has to make before anything else. }}'],
 'points_html' => ['{{ decision 1 }}', '{{ decision 2 }}', '{{ decision 3 }}'],
 'caveat_html' => '{{ 30-50 words: what varies by nationality and personal history. }}'],
...
['type' => 'prose', 'eyebrow' => 'Reality check', 'heading' => 'What residency does and does not change',
 'body_html' => ['{{ 60-90 words: intro. }}',
   ['type' => 'defs', 'items' => [
     ['term' => 'What it changes', 'def_html' => '{{ 50-80 words }}'],
     ['term' => 'What it does not change', 'def_html' => '{{ 50-80 words: tax at home, banking access, obligations elsewhere }}'],
     ['term' => 'What it commits you to', 'def_html' => '{{ 50-80 words }}'],
   ]]]],
['type' => 'callout', 'label' => 'If you are reading this because of a video',
 'body_html' => ['{{ 60-90 words: the gap between the pitch and the paperwork, written without contempt for the reader. }}']],
...
['type' => 'next-step', 'heading' => 'When reading has taken you as far as it can',
 'body_html' => ['{{ 40-60 words: what a consultation adds beyond this cluster. }}'],
 'cta' => ['page' => 'book', 'label' => 'Book a consultation'],
 'secondary' => ['page' => 'services', 'label' => 'What we do'],
 'diy_html' => '{{ 30-50 words: the honest note that several of these guides end in "you may not need us". }}'],
],
];
