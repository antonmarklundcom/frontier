...
return [
'faqs' => [
  ['q' => 'When can the conversion be started?',        'a' => ['{{ 60-90 words: the conditions, cited to the residency guide. }}']],
  ['q' => 'What if my temporary status has lapsed?',    'a' => ['{{ 60-90 words: what can be repaired and what cannot. }}']],
  ['q' => 'Do I need to be in the country?',            'a' => ['{{ 60-90 words }}']],
  ['q' => 'Can you take this on if someone else filed the original?', 'a' => ['{{ 60-90 words: yes/no and what we would need. }}']],
],
'blocks' => [
...
['type' => 'quick-answer', 'eyebrow' => 'In one paragraph',
 ...
 'caveat' => '{{ 30-50 words: eligibility, records and the government\'s decision. }}'],
['type' => 'steps', 'eyebrow' => 'The engagement', 'heading' => 'What happens, in order',
 'intro' => ['{{ 40-60 words }}'],
 'items' => [
   ['title' => '{{ stage 1 — reviewing the existing file }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 2 }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'You'],
   ['title' => '{{ stage 3 }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Us'],
   ['title' => '{{ stage 4 }}', 'body' => ['{{ 50-80 words }}'], 'who' => 'Government'],
 ],
 'footnote' => '{{ 25-40 words: no duration for the review stage. }}'],
