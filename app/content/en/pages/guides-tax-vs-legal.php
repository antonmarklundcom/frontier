...
'faqs' => [
  ['q' => 'Does Paraguayan residency make me a Paraguayan tax resident?',
   'a_html' => ['{{ 60-90 words: answer plainly. Separate immigration status, RUC registration and tax residency, and say which of the three the reader has actually acquired by getting a cédula. }}']],
  ['q' => 'Does getting a RUC end my tax obligations at home?',
   'a_html' => ['{{ 60-90 words: no, and why — the home country decides its own rules, and most use tests the reader has not stopped meeting. Refer them to an adviser in their own jurisdiction. }}']],
  ['q' => 'Do I have to spend a certain amount of time in Paraguay?',
   'a_html' => ['{{ 60-90 words: distinguish the immigration-side expectation from the tax-side test. Do not merge them into one number. }}']],
  ['q' => 'Can you advise me on my home country\'s tax rules?',
   'a_html' => ['{{ 40-60 words: no, and say what we can do instead — describe the Paraguayan side accurately so the reader\'s own adviser has something correct to work from. }}']],
],
...
['type' => 'quick-answer',
 ...
 'caveat_html' => '{{ 30-50 words: this page describes the Paraguayan side only; nothing here can tell a reader whether they have ceased to be tax resident at home. }}',
],
...
['type' => 'comparison',
 ...
 'rows' => [
   ['label' => 'Who grants it',        'cells_html' => ['{{ authority }}', '{{ authority }}', '{{ how it arises }}']],
   ['label' => 'What proves it',       'cells_html' => ['{{ document }}', '{{ document }}', '{{ what evidences it }}']],
   ['label' => 'What it obliges you to do', 'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
   ['label' => 'What it does not do',  'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
   ['label' => 'How it ends',          'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
 ],
 'footnote_html' => '{{ 30-50 words: the sentence a reader should take away from this table. }}',
],
...
['type' => 'sources',
 'intro_html' => ['{{ 25-40 words: which source governs the Paraguayan test. }}'],
 'items' => [
...
['type' => 'next-step',
 ...
 'body_html' => ['{{ 40-60 words: when a reader needs a Paraguayan accountant and their own adviser in the same conversation, and what we do in that setup. }}'],
 'cta' => ['page' => 'book', 'label' => 'Book a consultation'],
 'secondary' => ['page' => 'services.ruc', 'label' => 'RUC and tax registration support'],
 'diy_html' => '{{ 30-50 words: who does not need us here. }}',
],
