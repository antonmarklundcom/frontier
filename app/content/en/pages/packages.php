...
return [
'faqs' => [
  ['q' => 'Why is the price not on this page yet?',   'a_html' => ['{{ 60-90 words: answer honestly while it is true; delete this question once prices are published. }}']],
  ['q' => 'What is not included in any package?',     'a_html' => ['{{ 60-90 words: third-party fees, named. }}']],
  ['q' => 'Do you mark up government or translation fees?', 'a_html' => ['{{ 60-90 words }}']],
  ['q' => 'What happens if the scope changes mid-engagement?', 'a_html' => ['{{ 60-90 words: written agreement before extra work, no surprise invoices. }}']],
],
'blocks' => [
...
['type' => 'comparison', 'eyebrow' => 'Scope', 'heading' => 'What each engagement covers',
 ...
 'rows' => [
   ['label' => 'Who it is for',        'cells_html' => ['{{ 10-20 words }}', '{{ 10-20 words }}', '{{ 10-20 words }}']],
   ['label' => 'Included work',        'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
   ['label' => 'Not included',         'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
   ['label' => 'Paid directly to others', 'cells_html' => ['{{ 12-25 words }}', '{{ 12-25 words }}', '{{ 12-25 words }}']],
   ['label' => 'Our fee',              'cells_html' => ['{{ agreed price — never an invented or example figure }}', '{{ agreed price }}', '{{ agreed price }}']],
 ],
 'footnote_html' => '{{ 30-50 words: the date the fees were set, the currency, and what triggers a change. }}'],
['type' => 'callout', 'label' => 'What a package cannot include',
 'body_html' => ['{{ 60-90 words: approval, a processing time, a bank account, or a tax outcome. Say it here, on the page where money is discussed. }}']],
...
['type' => 'next-step', 'heading' => 'A quote for your situation',
 'body_html' => ['{{ 40-60 words: the consultation is where a package becomes a number for this reader. }}'],
